...
/**
 * Created by Amy on 10/28/2014.
 */
public class ConnexusFileService {
    ...
    public static File getDataStorageDir(String dataName) {
        ...
        if (!path.mkdirs()) {
            Log.i(ConnexusSSARConstants.CONNEXUSSSAR_DEBUG_TAG, "Error creating file path for data storage directory");
        }
